...
export const routes: Routes = [
  ...
  {
    path: 'solicitud-rentador-detalle/:id',
    loadComponent: () => import('./pages/solicitud-rentador-detalle/solicitud-rentador-detalle.page').then(m => m.SolicitudRentadorDetallePage)
  },
